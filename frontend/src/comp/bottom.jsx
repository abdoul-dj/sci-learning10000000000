        ...
        <div className="px-8 md:px-16 py-14 flex flex-col justify-center bg-gradient-to-br from-[#eef4ff] to-[#f9fbff]">
          ...
          <div className="flex flex-wrap gap-4 mt-10">
            <button
              ...
              className="bg-[#C4419F] hover:bg-blue-600 px-8 py-4 rounded-md flex items-center gap-3 text-lg font-medium transition-all"
            >
              Get Started
              <ArrowRight size={20} />
            </button>
            ...
            <button
              ...
              className="border border-gray-300 hover:border-gray-400 px-8 py-4 rounded-md text-gray-700 font-medium transition-all"
            >
              Learn More
            </button>
          </div>
