        ...
        <div className="bg-[#f2f1ff] flex flex-col justify-center px-8 md:px-14 py-16">
          ...
          <div className="mt-10">
            <button
              ...
              className="bg-[#C4419F] hover:bg-blue-600 transition-all duration-300 text-white px-8 py-4 rounded-full flex items-center gap-3 text-lg font-medium shadow-md"
            >
              Start Your Journey
              <ArrowRight size={20} />
            </button>
