          ...
          <div>
            ...
            <div className="flex items-center gap-5 mt-10">
              ...
              <button
                ...
                className="bg-[#C4419F] cursor-pointer  px-6 py-3 rounded-xl shadow-xl transition font-medium"
              >
                Start Learning
              </button>
              ...
              <button
                onClick={() => navigate("/lessons")}
                className="border cursor-pointer border-[#C4419F] hover:bg-blue-50 text-[#C4419F] px-6 py-3 rounded-xl transition font-medium"
              >
                Explore Courses
              </button>
            ...
            <div className="mt-10 relative max-w-xl">
              ...
              <input
                ...
                onKeyDown={(e) => {
                  if (e.key === "Enter") {
                    navigate(`/lessons?q=${encodeURIComponent(topicSearch)}`);
                  }
                }}
              ...
              <button
                onClick={() => navigate(`/lessons?q=${encodeURIComponent(topicSearch)}`)}
                className="absolute right-1 top-1 bg-[#C4419F] cursor-pointer text-white py-3 px-3 rounded-xl"
              >
                <Search size={20} />
              </button>
